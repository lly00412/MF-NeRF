...
do
  ...
  python train.py \
    ...
    --dataset_name colmap \
    --exp_name nerf_llff/mfgrid_T20_levels_16_F_2_tables_8_rgb_2ly_128ch/${losses}/${SCENES}/ \
    ...
    --loss ${losses} \
    --save_output \
    --val_only --ckpt_path ${CKPT_DIR}/${SCENES}/epoch=19.ckpt \
    --warp
  done