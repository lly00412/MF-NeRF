...
PYBIND11_MODULE(render_tgt_volume, m) {
	...
	m.def("render_to_ref", &render_to_ref, "A function which renders a target depth map into a reference view", py::arg("shape"),py::arg("depth_map"), py::arg("conf_map"), py::arg("reference_cam"), py::arg("target_cam"));
}
