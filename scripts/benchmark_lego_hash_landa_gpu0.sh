...
export CKPT_DIR=/mnt/Data2/liyan/MF-NeRF/ckpts/nsvf/Synthetic_NSVF/Hash/fewshot40_v2/
export CUDA_VISIBLE_DEVICES=0
export PREFIX=Synthetic_NSVF/Hash/fewshot40_v2
...
python train_nsvf.py \
    ...
    --ckpt_path ${BASE_DIR}/${SCENES}/epoch=19.ckpt \
    --pre_train_epoch 20 \
    --start 30 --N_vs 5 --view_step 2 --epoch_step 20 \
    --vs_by random \
    --no_save_vs \
    --vs_sample_rate 1.0
...
#    --grid Hash \
#    --view_select --vs_seed 66985 \
#    --ckpt_path ${BASE_DIR}/${SCENES}/random/retrain/epoch=19.ckpt \
#    --ray_sampling_strategy weighted_images \
#    --pre_train_epoch 20 \
#    --start 30 --N_vs 5 --view_step 2 --epoch_step 20 \
