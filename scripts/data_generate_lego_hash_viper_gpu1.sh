...
python data_generater.py --root_dir ${ROOT_DIR}/${SCENES} --dataset_name colmap --downsample 0.25 \
    ...
    --vs_seed 349378 --start 10 --N_more 0 --train_imgs 21 19 18 17 34 20 28 16 27 31 \
    --vs_sample_rate 1.0
...
python data_generater.py --root_dir ${ROOT_DIR}/${SCENES} --dataset_name colmap --downsample 0.25 \
    ...
    --batch_size 4096 --scale 16.0 --lr 2e-2 --eval_lpips \
    --L 16 --F 2 --T 20 --N_min 16 --grid Hash --rgb_channels 64 --rgb_layers 2 --random_bg \
    --vs_seed 349378 --start 10 --N_more 0 --train_imgs 43 53 24 51 47 20 22 29 17 13 \
    --vs_sample_rate 1.0
...
python data_generater.py --root_dir ${ROOT_DIR}/${SCENES} --dataset_name colmap --downsample 0.25 \
    ...
    --batch_size 4096 --scale 16.0 --lr 2e-2 --eval_lpips \
    --L 16 --F 2 --T 20 --N_min 16 --grid Hash --rgb_channels 64 --rgb_layers 2 --random_bg \
    --vs_seed 349378 --start 10 --N_more 0 --train_imgs 21 19 18 17 33 20 28 16 27 31 \
    --vs_sample_rate 1.0
...
python data_generater.py --root_dir ${ROOT_DIR}/${SCENES} --dataset_name colmap --downsample 0.25 \
    ...
    --batch_size 4096 --scale 16.0 --lr 2e-2 --eval_lpips \
    --L 16 --F 2 --T 20 --N_min 16 --grid Hash --rgb_channels 64 --rgb_layers 2 --random_bg \
    --vs_seed 349378 --start 10 --N_more 0 --train_imgs 47 13 17 46 22 20 29 18 32 28 \
    --vs_sample_rate 1.0
