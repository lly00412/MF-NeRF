...
export CKPT_DIR=/mnt/Data2/liyan/MF-NeRF/ckpts/colmap/nerf_llff/Hash/fewshot30/
...
python train.py \
    ...
    --dataset_name colmap \
    --downsample 0.25 \
    --exp_name nerf_llff/Hash/res0.25/fewshot30_v3/${SCENES}/ \
    --num_epochs 40 --batch_size 4096 --scale 16.0 --lr 2e-3 --eval_lpips \
    --L 16 --F 2 --T 20 --N_min 16 --grid Hash \
    --rgb_channels 64 --rgb_layers 2 \
    --view_select --vs_seed 349 \
...
#    --dataset_name colmap \
#    --downsample 0.25 \
#    --exp_name nerf_llff/Hash/res0.25/fewshot30_v2/${SCENES}/ \
#    --num_epochs 40 --batch_size 4096 --scale 16.0 --lr 2e-3 --eval_lpips \
#    --L 16 --F 2 --T 20 --N_min 16 --grid Hash \
#    --rgb_channels 64 --rgb_layers 2 \
#    --view_select --vs_seed 349 \
