...
losses=l2
export ROOT_DIR=/mnt/Data2/datasets/BlendedMVS/
export CKPT_DIR=/mnt/Data2/liyan/MF-NeRF/ckpts/nsvf/BlendedMVS/mfgrid_T20_levels_16_F_2_tables_8_rgb_2ly_128ch/${losses}/half_res/fewshot40/
...
do
  ...
  ### mfnerf T20 128ch
    python train.py \
      ...
      --dataset_name nsvf \
      --exp_name BlendedMVS/mfgrid_T20_levels_16_F_2_tables_8_rgb_2ly_128ch/${losses}/half_res/fewshot${FS}/${SCENES}/ \
